...
# instances
variable "aws_instance_type_sles" {
  type = string
}
variable "aws_ami_sles" {
  type = string
}
variable "node_count_sles" {
  type = string
}
variable "volume_size_root_sles" {
  type = string
}

variable "aws_instance_type_slm" {
  type = string
}
variable "aws_ami_slm" {
  type = string
}
variable "node_count_slm" {
  type = string
}
variable "volume_size_root_slm" {
  type = string
}
